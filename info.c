...
void
setauthor (pdf * document, char *author)
{
...
void
setcreator (pdf * document, char *creator)
{
  // Check the info object already exists
  checkInfo (document);
...
void
settitle (pdf * document, char *title)
{
  // Check the info object already exists
  checkInfo (document);
...
void
setsubject (pdf * document, char *subject)
{
  // Check the info object already exists
  checkInfo (document);
...
void
setkeywords (pdf * document, char *keywords)
{
  // Check the info object already exists
  checkInfo (document);

  // Add the keywords bit to it
  adddictitem (document->info->dict, "Keywords", gBracketedTextValue,
	       keywords);
}
