...
Dim panda As New panda_activex_dll.activex
Dim demo As Long
Dim currPage As Long
    ...
    demo = panda.panda_open("output.pdf", "w")
    ...
    DoEvents
    currPage = panda.panda_newpage(pdf, panda.panda_pagesize_a4)
    
    ' Put in the background images
    status.Text = status.Text & "TIFF images" & vbCr & vbLf
    DoEvents
    panda.panda_imagebox demo, currPage, 0, 0, 200, 200, "input.tif", panda.panda_image_tiff
    panda.panda_imagebox demo, currPage, 200, 0, 400, 200, "input2.tif", panda.panda_image_tiff
    
    status.Text = status.Text & "JPEG images" & vbCr & vbLf
    DoEvents
    panda.panda_imagebox demo, currPage, 317, 317, 434, 434, "gnu_box.jpg", panda_image_jpeg
    panda.panda_imagebox demo, currPage, 434, 434, 551, 551, "gnu_box.jpg", panda_image_jpeg
    ...
    DoEvents
    panda.panda_imageboxrot demo, currPage, 600, 0, 717, 117, 15, "gnu_box.jpg", panda_image_jpeg
    panda.panda_imageboxrot demo, currPage, 600, 200, 717, 317, 30, "gnu_box.jpg", panda_image_jpeg
    panda.panda_imageboxrot demo, currPage, 600, 400, 717, 517, 42, "gnu_box.jpg", panda_image_jpeg
    panda.panda_imageboxrot demo, currPage, 700, 0, 817, 117, 90, "gnu_box.jpg", panda_image_jpeg
    panda.panda_imageboxrot demo, currPage, 700, 200, 817, 317, 132, "gnu_box.jpg", panda_image_jpeg

    ' Insert a PNG to show that I can
    status.Text = status.Text & "PNG images" & vbCr & vbLf
    DoEvents
    panda.panda_imageboxrot demo, currPage, 100, 200, 200, 300, 0, "libpng.png", panda_image_png
    panda.panda_imageboxrot demo, currPage, 300, 200, 400, 300, 0, "gnu.png", panda_image_png
    panda.panda_imageboxrot demo, currPage, 100, 420, 310, 620, 36, "RedbrushAlpha.png", panda_image_png

    ' (c) statement
    panda.panda_setfont demo, panda.panda_createfont(demo, "Times-Roman", 1, "MacRomanEncoding")
    panda.panda_textbox demo, currPage, 600, 10, 700, 300, _
        "The background image on this page is Copyright 2000 Andrew Cagney"
    panda.panda_textbox demo, currPage, 620, 10, 720, 300, _
        "and is distributed under the terms of the GPL..."
    panda.panda_textbox demo, currPage, 310, 320, 330, 800, _
  ...
  currPage = panda.panda_newpage(demo, panda.panda_pagesize_a4)
...
'    }
    ...
    DoEvents
'  panda_setfontmode (demo, panda_textmode_normal);
'    panda.panda_textbox demo, currPage, 40, 10, 55, 200, _
'        "Please note that these shapes are lines, and there is no"
'    panda.panda_textbox demo, currPage, 60, 10, 75, 200, _
'         "requirement to have the shapes closed..."

    ' Straight lines of all types -- stroked
    status.Text = status.Text & "Straight lines" & vbCr & vbLf
    DoEvents
    panda.panda_setlinestart currPage, 110, 110
    panda.panda_addlinesegment currPage, 160, 130
    panda.panda_addlinesegment currPage, 210, 186
    panda.panda_addlinesegment currPage, 96, 22
    panda.panda_closeline currPage
    panda.panda_strokeline currPage
    panda.panda_endline currPage
    
    ' Now some curves -- stroked
    status.Text = status.Text & "Curves" & vbCr & vbLf
    DoEvents
    panda.panda_setlinestart currPage, 210, 210
    panda.panda_addcubiccurvesegment currPage, 310, 210, 225, 300, 275, 400
    panda.panda_addquadraticcurvesegmentone currPage, 160, 160, 200, 225
    panda.panda_addquadraticcurvesegmenttwo currPage, 210, 210, 250, 375
    panda.panda_closeline currPage
    panda.panda_strokeline currPage
    panda.panda_endline currPage
    ...
    DoEvents
    panda.panda_rectangle currPage, 210, 210, 310, 310
    panda.panda_strokeline currPage
    panda.panda_endline currPage
    ...
    DoEvents
    panda.panda_setlinecolor currPage, 99, 33, 255
    panda.panda_setfillcolor currPage, 112, 38, 300
    panda.panda_setlinestart currPage, 110, 310
    panda.panda_setlinewidth currPage, 5
    panda.panda_addlinesegment currPage, 160, 330
    panda.panda_addlinesegment currPage, 210, 386
    panda.panda_addlinesegment currPage, 96, 222
    panda.panda_closeline currPage
    panda.panda_fillline currPage
    panda.panda_endline currPage
    
    ' Now some curves -- stroked and filled
    status.Text = status.Text & "Filled curves" & vbCr & vbLf
    DoEvents
    panda.panda_setfillcolor currPage, 112, 138, 37
    panda.panda_setlinestart currPage, 210, 410
    panda.panda_setlinewidth currPage, 5
    panda.panda_addcubiccurvesegment currPage, 310, 410, 225, 500, 275, 600
    panda.panda_addquadraticcurvesegmentone currPage, 160, 360, 200, 425
    panda.panda_addquadraticcurvesegmenttwo currPage, 210, 410, 250, 575
    panda.panda_closeline currPage
    panda.panda_fillline currPage
    panda.panda_endline currPage
    ...
    DoEvents
    panda.panda_setfillcolor currPage, 38, 38, 38
    panda.panda_setlinewidth currPage, 5
    panda.panda_rectangle currPage, 410, 210, 510, 310
    panda.panda_fillline currPage
    panda.panda_endline currPage
    ...
    DoEvents
    panda.panda_setlinewidth currPage, 10
    panda.panda_setlinestart currPage, 100, 600
    panda.panda_addlinesegment currPage, 200, 600
    panda.panda_strokeline currPage
    panda.panda_endline currPage
    ...
    DoEvents
    panda.panda_setlinewidth currPage, 10
    panda.panda_setlinecap currPage, panda.panda_linecap_butt
    panda.panda_setlinestart currPage, 100, 625
    panda.panda_addlinesegment currPage, 200, 625
    panda.panda_strokeline currPage
    panda.panda_endline currPage
    ...
    DoEvents
    panda.panda_setlinewidth currPage, 10
    panda.panda_setlinecap currPage, panda.panda_linecap_round
    panda.panda_setlinestart currPage, 100, 650
    panda.panda_addlinesegment currPage, 200, 650
    panda.panda_strokeline currPage
    panda.panda_endline currPage
    ...
    DoEvents
    panda.panda_setlinewidth currPage, 10
    panda.panda_setlinecap currPage, panda.panda_linecap_projectedsquare
    panda.panda_setlinestart currPage, 100, 675
    panda.panda_addlinesegment currPage, 200, 675
    panda.panda_strokeline currPage
    panda.panda_endline currPage
    ...
    panda.panda_setlinewidth currPage, 10
    panda.panda_setlinecap currPage, panda.panda_linecap_butt
    panda.panda_setlinestart currPage, 300, 600
    panda.panda_addlinesegment currPage, 350, 650
    panda.panda_addlinesegment currPage, 400, 600
    panda.panda_strokeline currPage
    panda.panda_endline currPage
    ...
    DoEvents
    panda.panda_setlinewidth currPage, 10
    panda.panda_setlinejoin currPage, panda.panda_linejoin_miter
    panda.panda_setlinestart currPage, 300, 625
    panda.panda_addlinesegment currPage, 350, 675
    panda.panda_addlinesegment currPage, 400, 625
    panda.panda_strokeline currPage
    panda.panda_endline currPage
    ...
    DoEvents
    panda.panda_setlinewidth currPage, 10
    panda.panda_setlinejoin currPage, panda.panda_linejoin_round
    panda.panda_setlinestart currPage, 300, 650
    panda.panda_addlinesegment currPage, 350, 700
    panda.panda_addlinesegment currPage, 400, 650
    panda.panda_strokeline currPage
    panda.panda_endline currPage
    ...
    DoEvents
    panda.panda_setlinewidth currPage, 10
    panda.panda_setlinejoin currPage, panda.panda_linejoin_bevel
    panda.panda_setlinestart currPage, 300, 675
    panda.panda_addlinesegment currPage, 350, 725
    panda.panda_addlinesegment currPage, 400, 675
    panda.panda_strokeline currPage
    panda.panda_endline currPage
    ...
    DoEvents
    panda.panda_setlinedash currPage, 1, 0, 0
    panda.panda_setlinejoin currPage, panda.panda_linejoin_round
    
    status.Text = status.Text & "Dashed lines, 2" & vbCr & vbLf
    DoEvents
    panda.panda_setlinestart currPage, 100, 800
    panda.panda_addlinesegment currPage, 100, 750
    panda.panda_addlinesegment currPage, 140, 800
    panda.panda_closeline currPage
    panda.panda_strokeline currPage
    panda.panda_endline currPage
    ...
    DoEvents
    panda.panda_setlinedash currPage, 3, 3, 0
    panda.panda_setlinestart currPage, 150, 800
    panda.panda_addlinesegment currPage, 150, 750
    panda.panda_addlinesegment currPage, 190, 800
    panda.panda_closeline currPage
    panda.panda_strokeline currPage
    panda.panda_endline currPage
    ...
    DoEvents
    panda.panda_setlinedash currPage, 2, 1, 1
    panda.panda_setlinestart currPage, 200, 800
    panda.panda_addlinesegment currPage, 200, 750
    panda.panda_addlinesegment currPage, 240, 800
    panda.panda_closeline currPage
    panda.panda_strokeline currPage
    panda.panda_endline currPage
